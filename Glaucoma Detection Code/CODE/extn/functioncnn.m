function cnn=functioncnn(cnn, xx)
    ...
    if cnn.layers{i}.type == 'c'
        ...
        for j=1:cnn.layers{i}.no_featuremaps
            ...
            for k=1:cnn.layers{i-1}.no_featuremaps
                kk = kk +1;
                z = z + convn(cnn.layers{i-1}.featuremaps{k},rot90(cnn.layers{i}.K(:,:,kk),2),'valid'); 
            ...
            if cnn.layers{i}.act_func == 'soft'
                ...
                cnn.layers{i}.featuremaps{j} = applyactivationfunccnn(z+ cnn.layers{i}.b(j),cnn.layers{i}.act_func, 0);
%                 
            end
        end
        if cnn.layers{i}.act_func == 'soft'
    ...
    elseif cnn.layers{i}.type == 'f'
            ...
            if cnn.layers{i-1}.type  ~= 'f'
                ...
                cnn.layers{i}.outputs = applyactivationfunccnn(cnn.layers{i}.W*zz + repmat(cnn.layers{i}.b, 1, size(zz,2)), cnn.layers{i}.act_func, 0); 
